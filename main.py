...
lohith_image = face_recognition.load_image_file("Pics/Lohith.jpg")
lohith_face_encoding = face_recognition.face_encodings(lohith_image)[0]

mehul_image = face_recognition.load_image_file("Pics/Mehul.jpg")
mehul_face_encoding = face_recognition.face_encodings(mehul_image)[0]

richard_image = face_recognition.load_image_file("Pics/Richard.jpg")
richard_face_encoding = face_recognition.face_encodings(richard_image)[0]

sami_image = face_recognition.load_image_file("Pics/Sam.jpg")
